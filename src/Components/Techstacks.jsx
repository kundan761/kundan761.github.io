      ...
      <div className="logosofstacks">
        ...
        >
          <div className="coin Css_logo">
            <div className="side heads skills-card">
              <svg
                className="css-logo-width skills-card"
                xmlns="http://www.w3.org/2000/svg"
                width={"4.3rem"}
                viewBox="0 0 128 128"
                id="css3"
        ...
        >
          ...
          <div className="coin Expressjs_logo">
            <div className="side heads skills-card">
              <img src={bootstrap} className="skills-card" alt="bootstrap" />
            </div>
            <div className="side tails">
        ...
        <Tooltip
          hasArrow
          label="JavaScript"
          className="tooltip-font skills-card-name"
          bg={"#f7df1e"}
          color={"black"}
        >
          {/* <div className='skills-card'> */}
        ...
        >
          <div className="coin Typesscript_logo">
            <div className="side heads">
              <img
                className="css-logo-width typescript skills-card-img"
                src={typescript}
                alt="typescript"
              />
            </div>
            <div className="side tails">
              <img
                className="css-logo-width typescript"
                src={typescript}
                alt="typescript"
              />
            </div>
        ...
        >
          <div className="coin Mongo_logo">
            <div className="side heads">
              <img
                className="css-logo-width skills-card-img logo_spin"
                src={mysql}
                alt=""
              />
            </div>
        ...
        >
          ...
          <div className="coin Expressjs_logo">
            <div className="side heads skills-card">
              <img src={nextjs} className="skills-card" alt="" />
            </div>
            <div className="side tails">
              <img src={nextjs} alt="" />
            </div>
        ...
        >
          ...
          <div className="coin Expressjs_logo">
            <div className="side heads skills-card">
              <img src={postman} className="skills-card" alt="postman" />
            </div>
            <div className="side tails">
        ...
        >
          ...
          <div className="coin Expressjs_logo">
            <div className="side heads skills-card">
              <img src={materialUi} className="skills-card" alt="materialUi" />
            </div>
            <div className="side tails">
        ...
        >
          ...
          <div className="coin Expressjs_logo">
            <div className="side heads skills-card">
              <img src={figma} className="skills-card" alt="figma" />
            </div>
            <div className="side tails">
