...
const Intro = () => {
  ...
  const whatsapplink = () => {
    window.open(profile.socials.whatsapp)
  }
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          ...
          >
            ...
            <motion.div 
              ...
              className="flex items-center gap-4 mb-10 max-[480px]:flex-col max-lg:justify-center w-full lg:w-auto"
            >
              <a 
                href="#contact" 
                className="inline-flex items-center justify-center min-w-[140px] gap-2 bg-accent text-white border-none rounded-full px-6 py-3 text-[0.9rem] font-bold transition-all duration-300 tracking-wide hover:bg-accent-light hover:-translate-y-[1px] hover:shadow-[0_6px_20px_rgba(249,115,22,0.4)]"
              >
            ...
            <motion.div
              ...
              className='flex gap-3 mt-0 max-lg:justify-center'
            >
              <motion.div onClick={githublink} id="contact-github" className="group w-11 h-11 bg-white/5 border border-border rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 hover:bg-[rgba(249,115,22,0.1)] hover:border-border-accent"
                whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                <FaGithub className='w-[22px] h-[22px] text-text-secondary transition-all duration-300 group-hover:text-accent' />
              </motion.div>
              <motion.div onClick={linkedinlink} id="contact-linkedin" className="group w-11 h-11 bg-white/5 border border-border rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 hover:bg-[rgba(249,115,22,0.1)] hover:border-border-accent"
                whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                <FaLinkedinIn className='w-[22px] h-[22px] text-text-secondary transition-all duration-300 group-hover:text-accent' />
              </motion.div>
              <motion.div onClick={whatsapplink} id="contact-whatsapp" className="group w-11 h-11 bg-white/5 border border-border rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 hover:bg-[rgba(249,115,22,0.1)] hover:border-border-accent"
                whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                <MessageCircle className='w-[22px] h-[22px] text-text-secondary transition-all duration-300 group-hover:text-accent' />
              </motion.div>
              <motion.div onClick={emaillink} id="contact-email-icon" className="group w-11 h-11 bg-white/5 border border-border rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 hover:bg-[rgba(249,115,22,0.1)] hover:border-border-accent"
                whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                <Mail className='w-[22px] h-[22px] text-text-secondary transition-all duration-300 group-hover:text-accent' />
              </motion.div>
            </motion.div>
          </motion.div>
